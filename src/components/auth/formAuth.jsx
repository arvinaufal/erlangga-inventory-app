        ...
        <form onSubmit={formType === 'register' ? handleRegister : handleLogin}>
            ...
            {/* {
                pending
                    ...
                    <div className="h-12 rounded-xl justify-center content-center items-center cursor-pointer flex mt-4 bg-blue-600/40 disabled">
                        <span className="loading loading-spinner loading-md"></span>
                    </div>
                    :
                    <button type="submit" className="h-12 w-full bg-blue-700 rounded-xl justify-center content-center items-center cursor-pointer flex mt-4 hover:bg-blue-500" onClick={formType === 'register' ? () => { handleRegister(); setPending(true); } : () => { handleLogin(); setPending(true); }}>
